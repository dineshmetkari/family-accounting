...
public class DocumentsListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        case DocumentsListAdapterItem.INCOMING_VIEW:
            ...
            fillItemIncomingView(view, item);
            break;
     ...
     * @param item
     */
    private void fillItemIncomingView(View view, DocumentsListAdapterItem item) {
        DataCore dataCore = DataCore.getInstance();
        CoreDriver coreDriver = dataCore.getCoreDriver();
        ...
        MasterDataManagement mdMgmt = coreDriver.getMasterDataManagement();
        TextView incomingAccount = (TextView) view
                .findViewById(R.id.accountValue);
        TextView customer = (TextView) view.findViewById(R.id.customerValue);
        TextView revAccount = (TextView) view.findViewById(R.id.revAccount);
        TextView dateField = (TextView) view.findViewById(R.id.pstingDateValue);
        TextView amountFiled = (TextView) view.findViewById(R.id.amountValue);
        TextView descp = (TextView) view.findViewById(R.id.descp);
        try {
            // rec account
            MasterDataIdentity id = (MasterDataIdentity) item.Document
                    .getValue(CustomerEntry.REC_ACC);
            MasterDataBase data = mdMgmt.getMasterData(id,
                    MasterDataType.GL_ACCOUNT);
            incomingAccount.setText(data.getDescp());

            // customer
            id = (MasterDataIdentity) item.Document
                    .getValue(CustomerEntry.CUSTOMER);
            data = mdMgmt.getMasterData(id, MasterDataType.CUSTOMER);
            customer.setText(data.getDescp());

            // revenue account
            id = (MasterDataIdentity) item.Document
                    .getValue(CustomerEntry.GL_ACCOUNT);
            data = mdMgmt.getMasterData(id, MasterDataType.GL_ACCOUNT);
            revAccount.setText(data.getDescp());
    ...
    /**
     * fill customized view
     * 
     * @param view
     * @param item
     */
    private void fillCustomizedView(View view, DocumentsListAdapterItem item) {
        TextView descp = (TextView) view.findViewById(R.id.descp);
