...
import com.jasonzqshen.familyaccounting.core.exception.DocReservedException;
import com.jasonzqshen.familyaccounting.core.exception.ReverseOrgDocNotExistException;
...
public class DocumentsListActivity extends ListActivity {
	...
	private final DialogInterface.OnClickListener _REVERSE_OK_LISTENER = new DialogInterface.OnClickListener() {
		...
		public void onClick(DialogInterface dialog, int which) {
			...
			try {
				transMgmt.reverseDocument(_selectedDocItem.Document.getDocument()
						.getDocIdentity());
			} catch (ReverseOrgDocNotExistException e) {
				throw new SystemException(e);
			} catch (DocReservedException e) {
