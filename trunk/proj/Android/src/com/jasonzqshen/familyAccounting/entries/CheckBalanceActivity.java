...
public class CheckBalanceActivity extends BalanceReportActivityBase {
			...
			try {
				...
				if (_newValueList.containsKey(_selectedItem.Account)) {
					...
					AmountPair newAmountPair = new AmountPair(
							(GLAccountMasterData) _selectedItem.Account,
							amountPair.OrgAmount, amount);
	...
	private void save() {
		...
		try {
			...
			// waring the data is not save to file system
			Toast.makeText(this, this.getString(R.string.message_dirty_data),
